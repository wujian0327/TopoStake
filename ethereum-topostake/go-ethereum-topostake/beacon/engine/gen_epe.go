...
func (e ExecutionPayloadEnvelope) MarshalJSON() ([]byte, error) {
	...
	enc.TopoStakeBlockEvidence = e.TopoStakeBlockEvidence
...
func (e *ExecutionPayloadEnvelope) UnmarshalJSON(input []byte) error {
	...
	if dec.TopoStakeBlockEvidence != nil {
		e.TopoStakeBlockEvidence = append(json.RawMessage(nil), dec.TopoStakeBlockEvidence...)
	}
	return nil
}
