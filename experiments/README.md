...
- `frozen_v1_adaptive_participation_sensitivity.yaml`: independent 160-run,
  20-seed one-factor sensitivity check for the frozen baseline, update rate,
  hysteresis, and symmetric exploration at the representative `50%`-initial,
  `2x`-cost condition.
