...
We consider a permissionless P2P blockchain network.
...
We further assume that the honest-validator subgraph remains connected after GST, as required by the underlying PoS protocol.
...
Therefore,
\begin{equation}
\text{propagation in epoch } e-1
\longrightarrow
\text{proposer weight in epoch } e.
\end{equation}
